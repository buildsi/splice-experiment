...
Not e4s, but have tests (and were added)
 ...
 - [x] gdal/expat ([run](https://github.com/buildsi/splice-experiment-runs/actions/runs/2780033083)) had a lot of install errors for a dep
 ...
 - [x] gdal/proj ([run](https://github.com/buildsi/splice-experiment-runs/actions/runs/2786701443))
 - [x] gdal/qhull ([run](https://github.com/buildsi/splice-experiment-runs/actions/runs/2786703032))
 - [x] gdal/sqlite ([run](https://github.com/buildsi/splice-experiment-runs/actions/runs/2786703938))
 - [x] gdal/zlib ([run](https://github.com/buildsi/splice-experiment-runs/actions/runs/2786705688))
 ...
 - [x] genesis/openmpi ([run](https://github.com/buildsi/splice-experiment-runs/actions/runs/2786706738))
