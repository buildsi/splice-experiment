...
This is a manual test of installing the main packages (to be spliced) - if this fails, there is no point attempting them in the experiment. Spack MUST build and splice them to get any kind of result. From the below, I've derived the following list of packages we can run/test in GitHub actions:
 ...
 - [ ] qthreads/numactl ([run](https://github.com/buildsi/splice-experiment-runs/actions/runs/2757243225))
 - [ ] hdf5/cmake ([run](https://github.com/buildsi/splice-experiment-runs/actions/runs/2757873336))
 - [ ] hdf5/openmpi ([run]())
 - [ ] hdf5/pkgconf ([run]())
 - [ ] hdf5/zlib ([run](https://github.com/buildsi/splice-experiment-runs/actions/runs/2757273049))
 - [ ] raja/blt ([run](https://github.com/buildsi/splice-experiment-runs/actions/runs/2757243847))
 - [ ] raja/camp ([run](https://github.com/buildsi/splice-experiment-runs/actions/runs/2757270909))
 - [ ] raja/cmake ([run]())
 - [ ] upcxx/python ([run]())
 - [ ] arborx/cmake ([run]())
 - [ ] arborx/kokkos ([run]())
